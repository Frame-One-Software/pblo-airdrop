...
contract PBLOToken  is Context, IERC20, Ownable {
    ...
    address public _charityWallet = 0xea7B7F3f711DfACbB37196878723E3cf946C0A4c;
    address public _marketingWallet = 0xEAD47e6AFa1D816d250ddb68443ea631bBddbAFA;

    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 924999989100014880001000000000000;   // TOTAL SUPPLY 5th JUNE 
    ...
    constructor () public {
        ...
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x5A1A923DC18dBe8688a89a805f199e4080c00B91);
